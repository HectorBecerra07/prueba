...
export default function VideoDetalle() {
  ...
  if (loading) {
    return (
      <div className="px-6 md:px-16 py-20 flex flex-col items-center justify-center min-h-[400px]">
  ...
  if (!producto) {
    return (
      <div className="px-6 md:px-16 py-16 text-center">
        ...
        <p className="mb-6 text-gray-700">El video que estás buscando no existe o fue removido.</p>
        <button
