...
const proyectos = [
  {
    ...
    imagen: "/img/proyectosEmpresariales/franquisias.jpg", // ruta corregida
  },
  {
    id: 2,
    ...
    <section className="mt-16 bg-white py-14 px-6 md:px-10">
      ...
      <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
        {proyectos.map((proyecto) => (
          <div
            key={proyecto.id}
            className="bg-gray-100 rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden transition duration-300"
          >
            <img
              src={proyecto.imagen}
              alt={proyecto.titulo}
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 text-base">{proyecto.descripcion}</p>
            </div>
          </div>
        ))}
      </div>
