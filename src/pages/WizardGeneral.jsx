...
const configuraciones = {
  Purificadora: [
    { id: "Purificadora1", nombre: "Mostrador", descripcion: "Agua purificada", precio: 100000, imagen: "/img/purificadora1.png" },
    { id: "Purificadora2", nombre: "Mostrador", descripcion: "Agua purificada con Osmosis inversa", precio: 120000, imagen: "/img/purificadora1.png" },
    { id: "Purificadora3", nombre: "Mostrador", descripcion: "Agua purificada + Agua Alcalina", precio: 200000, imagen: "/img/purificadora1.png" },
    { id: "Purificadora4", nombre: "Mostrador", descripcion: "Agua premium con osmosis inversa + Agua Alcalina", precio: 95000, imagen: "/img/purificadora1.png" },
  ],
  Vending: [
...
export default function WizardGeneral() {
  const { id } = useParams();
  const modelos = configuraciones[id] || [];
  ...
  const [extraTouchPrice, setExtraTouchPrice] = useState(id !== "Vending" ? 0 : 0);
      ...
      {id === "Vending" && step === 0 && (
        <div className="col-span-2">
          <Step0SelectVendingType
            onSelect={(type) => {
              setVendingType(type);
              if (type === "Touch") setExtraTouchPrice(3000);
              setStep(1);
            }}
          />
        </div>
